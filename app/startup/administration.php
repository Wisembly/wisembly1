...
$app->match('/administration/{table}/all', function (Application $app, Request $req, $table) {
    ...
    return new TransientResponse($app['twig'], 'administration_all.html.twig', array('table' => $table, 'form' => $form->createView()));
})
->bind('administration_all');
